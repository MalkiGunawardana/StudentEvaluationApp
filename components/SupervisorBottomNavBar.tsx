...
export default function SupervisorBottomNavBar({ navigation }: { navigation: any }) {
  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate("SuperHome")} // Ensure this route name matches your navigator
      >
      ...
      <TouchableOpacity
        style={styles.navItem}
        onPress={() => navigation.navigate("Performance1Results")} // Ensure this route name matches your navigator
      >
      ...
      >
        <MaterialIcons name="edit" size={28} color={isActive("AddMarksScreen") ? "#1565c0" : "#757575"} />
        <Text style={[styles.navLabel, isActive("AddMarksScreen") && styles.activeLabel]}>Marks</Text>
      </TouchableOpacity>      
      <TouchableOpacity
        style={styles.navItem}
        onPress={() => navigation.navigate("SupervisorUserProfile", { performance: 'performance1' })}
      >
