import { MaterialIcons } from "@expo/vector-icons"; // For action button icons
...
import { Avatar, Button, Text } from "react-native-paper"; // Added Avatar
        ...
        <ScrollView style={styles.webMainContent}>
          ...
          {loading ? (
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <Text style={styles.emptyListText}>No events available.</Text>
              }
...
const styles = StyleSheet.create({
  ...
  topShapeContainer: {
    ...
    left: 0,
    right: 0,
    height: 150, // Matched SuperHomeScreen
    zIndex: 1,
  },
  topShape: {
    backgroundColor: "#1565c0",
    height: 150, // Matched SuperHomeScreen
    borderBottomLeftRadius: 60, // Matched SuperHomeScreen
    borderBottomRightRadius: 60, // Matched SuperHomeScreen
    opacity: 0.15,
  },
  topBarContainer: { // Container for the content within the shape
    ...
    left: 0,
    right: 0,
    height: 110, // Matched SuperHomeScreen
  ...
  topBarInternal: { // The actual row for welcome, name, date, logo
    ...
    // marginBottom: 10, // Removed to match SuperHomeScreen
  },
  welcomeTitle: {
    fontSize: 20, // Matched SuperHomeScreen
    color: "#1565c0",
    fontWeight: "bold",
    marginTop: 20, // Matched SuperHomeScreen
    marginBottom: 2, // Matched SuperHomeScreen
  ...
  topBarLogo: {
    width: 100, // Matched SuperHomeScreen
    height: 100, // Matched SuperHomeScreen
    marginLeft: 10,
  },
  ...
  container: {
    ...
    paddingTop: 160, // Push content below the larger shape
    paddingBottom: 10,
  },
  statsContainer: {
    flexDirection: "row",
  ...
  flatListContent: { paddingBottom: 80 }, // Ensure scroll past nav bar
  ...
  webSectionTitle: {
    ...
    color: '#4A5568',
    marginBottom: 16,
    marginTop: 24, // Add some space above the title after the action buttons
  },
});
